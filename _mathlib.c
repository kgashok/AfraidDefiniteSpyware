...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__mathlib(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__mathlib(void) { return NULL; }
#  else
     init_mathlib(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__mathlib(void)
{
  return _cffi_init("_mathlib", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_mathlib(void)
{
  _cffi_init("_mathlib", 0x2601, &_cffi_type_context);
}
#endif
